...
public class Main {
	...
	public static void main(String[] args) {
		...
		do {
			...
			Pietre pietreGiocatori = new Pietre();
			...
			case 1:
				...
				//Pietre pietreGiocatori = new Pietre();
				pietreGiocatori.addscortaComune();
				for (int i = 0; i < NUM_TAMAGOLEM_PER_GIOCATORE; i++) {
					int count = i;
					System.out.println("\nGolem " + (++count) + " del Giocatore 1\n");
					giocatore1.addSquadra(new TamaGolem(MAX_VITA_GOLEM, pietreGiocatori.MenuSceltaPietre()));
				}
				...
				for (int i = 0; i < NUM_TAMAGOLEM_PER_GIOCATORE; i++) {
					int count = i;
					System.out.println("\nGolem " + (++count) + " del Giocatore 1\n");
					giocatore2.addSquadra(new TamaGolem(MAX_VITA_GOLEM, pietreGiocatori.MenuSceltaPietre()));
				}
